 ...
 * Social/brand icons.
 *
 * lucide-react removed brand glyphs (Instagram, Facebook, YouTube, X/Twitter,
 * LinkedIn) for trademark reasons, so we provide them locally with the same
 * lightweight API (`className`, `size`) the rest of the app uses.
 */
